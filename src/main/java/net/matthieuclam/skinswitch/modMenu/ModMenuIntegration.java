package net.matthieuclam.skinswitch.modMenu;
...
public class ModMenuIntegration implements ModMenuApi {
    ...
    public class ModMenuOptionsScreen extends GameOptionsScreen {
        ...
        public ModMenuOptionsScreen(Screen parent) {
            super(parent, MinecraftClient.getInstance().options, Text.translatable("options.switchskinmod.title"));
        }

        protected void init() {
            this.list = new ButtonListWidget(this.client, this.width, this.height, 32, this.height - 32, 25);
            this.list.addAll(Config.asOptions());
